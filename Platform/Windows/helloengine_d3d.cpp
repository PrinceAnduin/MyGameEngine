...
ID3D11InputLayout       *g_pLayout      = nullptr;  // the pointer to input layout
...
void CreateRenderTarget()
{
    ...
    // Get a pointe to the back buffer
...
void InitPipeline()
{
    ...
    // create the inpyut layout objects
...
void InitGrapthics()
{
    ...
    memcpy(ms.pData, Vertices, sizeof(VERTEX) * 3);
...
HRESULT CreateGraphicsResources(HWND hWnd)
{
    ...
    {
        // struct to hold information of swap chain
        ...
        scd.Windowed = TRUE;
        scd.Flags = DXGI_SWAP_CHAIN_FLAG_ALLOW_MODE_SWITCH; // allow full-screen mode switch
